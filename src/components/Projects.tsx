...
const PROJECTS = [
  ...
  },
  {
    number: "02",
    title: "DesiVest",
    subtitle: "Cross-Border Investment & Tax Intelligence · Solo Build",
    description:
...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={sectionRef} style={{ padding: "80px 0", background: "#030303", position: "relative" }}>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
                <span style={{
                  ...
                  color: "rgba(255,255,255,0.06)", fontFamily: "var(--font-geist-mono)", letterSpacing: "-2px",
                }}>
                  {project.number}
                </span>
                <div style={{ display: "flex", gap: "8px" }}>
                  {[
                    { href: project.github, label: "GitHub", icon: <FaGithub size={14} /> },
                    { href: project.github, label: "Live", icon: <ExternalLink size={14} /> },
                  ].map(({ href, label, icon }) => (
                    <a
                      key={label}
                      href={href}
              ...
              {/* Content */}
              <p style={{ fontSize: "10px", letterSpacing: "3px", textTransform: "uppercase", color: project.color, marginBottom: "8px", fontWeight: 600 }}>
                {project.subtitle}
              </p>
              <h3 style={{ fontSize: "clamp(20px, 3vw, 30px)", fontWeight: 800, color: "white", letterSpacing: "-0.5px", marginBottom: "12px" }}>
                {project.title}
              </h3>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                {project.tags.map((tag) => (
                  <span key={tag} style={{
                    ...
                    fontFamily: "var(--font-geist-mono)", border: "1px solid rgba(255,255,255,0.07)",
                  }}>
                    {tag}
                  </span>
                ))}
